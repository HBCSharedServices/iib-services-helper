...
public class TaxServiceResponseContent {
	...
	public TaxServiceResponseContent() {
	}

	public TaxServiceResponseContent(String order_number, String banner_code, String country_code, String store_number, String postal_code, String state_province, String city, String tax_exempt_flag, List<TaxServiceLineItem> line_item) {
	...
	public boolean equals(Object responseObj) {
		...
		try {
			...
			if (!(responseObj instanceof TaxServiceResponseContent) || responseObj == null)
				return false;

			Field[] fields = TaxServiceResponseContent.class.getDeclaredFields();
