...
public abstract class Asset {
    ...
    public Boolean validateDateFormats(Object responseObj) {
        Field[] fields = Asset.class.getDeclaredFields();
        for (Field field : fields) {
            Object responseVal = null;
            try {
                responseVal = field.get(responseObj);
	...
	public boolean equals(Object responseObj) {
		...
		try {
			...
			for (Field field : fields) {
				...
				//Exclude all the fields that are generated by the system; status is created by system but it can also be set, thus it is not included here
