		...
		try {
			...
			for (Field field : fields) {
				...
				if (field.getName().equals("createdDate") || field.getName().equals("eventDate") || field.getName().equals("lastModifiedDate")) {
					...
					if (!(BaseHelper.isDateCorrectlyFormattedForISO8601WithMS((String) field.get(responseObj), field.getName()) && BaseHelper.isDateCorrectlyFormattedForISO8601WithMS((String) field.get(this), field.getName())))
						return false;
				}
