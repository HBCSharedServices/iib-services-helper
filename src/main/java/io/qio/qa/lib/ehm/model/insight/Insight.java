	...
	public boolean equals(Object responseObj) {
		...
		try {
			...
			for (Field field : fields) {
				...
				if (!(field.getName().contains("Date") && field.getName().equals("referenceId") && field.getName().equals("insightId") && field.getName().equals("insightTypeId") && field.getName().contains("Id"))) {
